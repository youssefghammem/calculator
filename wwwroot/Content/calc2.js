...
{
 "use strict";
 var calc2,Client,WebSharper,Obj,UI,HtmlModule,attr,Operators,Arrays,Templating,Runtime,Server,TemplateInstance,ProviderBuilder,Unchecked,calc2_Templates,AttrProxy,Doc,Elt,JavaScript,Pervasives,AttrModule,System,Guid,Collections,List,Handler,Client$1,Templates,Attrs,DomUtility,View,Dictionary,HashSet,Seq,TemplateInitializer,Var$1,EventTarget,Node,JS,Updates,Snap,Numeric,Object,Var,CheckedInput,DictionaryUtil,Enumerator,T,ConcreteVar,SC$1,WindowOrWorkerGlobalScope,Docs,Array,DocElemNode,CharacterData,Abbrev,Fresh,Prepare,Slice,KeyCollection,An,Settings,Mailbox,List$1,T$1,Attrs$1,Dyn,Strings,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$2,HashSetUtil,SC$3,SC$4,BindVar,SC$5,SC$6,AppendList,String,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,Char,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime$1,console,Date;
 calc2=Global.calc2=Global.calc2||{};
 Client=calc2.Client=calc2.Client||{};
 ...
 calc2_Templates=Global.calc2_Templates=Global.calc2_Templates||{};
 ...
 {
  var op,onum,num,display,calculator,a,b,_this,p,i;
  function updateDisplay()
  {
   display.SetValue(Global.String(num));
  }
  function D(n)
  {
   num=10*num+n;
  ...
  onum=0;
  num=0;
  display=Doc.Element("input",[AttrProxy.Create("type","text"),AttrProxy.Create("value","0")],[]);
  calculator=Doc.Element("div",[],[display,Doc.Element("br",[],[]),Doc.Element("div",[],[Doc.Element("br",[],[]),digit(7),digit(8),digit(9),btn("/","DIV",function($5)
  {
   return O(function($6)
   {
    return function($7)
  ...
  }),Doc.Element("br",[],[]),digit(4),digit(5),digit(6),btn("*","MULT",function($5)
  {
   return O(function($6)
   {
    return function($7)
  ...
  }),Doc.Element("br",[],[]),digit(1),digit(2),digit(3),btn("-","SUBS",function($5)
  {
   return O(function($6)
   {
    return function($7)
  ...
  }),Doc.Element("br",[],[]),digit(0),btn("AC","AC",function()
  {
   num=0;
   onum=0;
   op=null;
  ...
  }),Doc.Element("br",[],[]),btn("Cos","COS",function()
  {
   num=Math.cos(num);
   updateDisplay();
  }),btn("Sin","SIN",function()
  {
   num=Math.sin(num);
   updateDisplay();
  }),btn("1/x","DIV2",function()
  {
   num=1/num;
   num===-Global.Infinity||num===Global.Infinity?(display.SetValue("E"),num=0):updateDisplay();
  }),btn("+/-","OPP",function()
  {
   num=-num;
   updateDisplay();
  }),Doc.Element("br",[],[]),btn("=","E",function()
  {
   if(op!=null&&op.$==1)
    {
     num=(op.$0(onum))(num);
  ...
  a=(b=(_this=new ProviderBuilder.New$1(),(_this.h.push({
   ...
   $0:"main",
   $1:calculator
  }),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],calc2_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 calc2_Templates.main=function(h)
 {
